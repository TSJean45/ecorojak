  ...
  return (
    <SafeAreaView className="flex-1 bg-[#F9F9F9]">
      <ScrollView contentContainerStyle={{ paddingBottom: insets.bottom + 60 }}>
        ...
        >
          ...
          >
            <Image
              ...
              className="w-16 h-16"
            />
            <Text className="text-xs font-bold mt-1">Rideshare</Text>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            <Image
              ...
              className="w-16 h-16"
            />
            <Text className="text-xs font-bold mt-1">EcoLens</Text>
          </TouchableOpacity>
          <TouchableOpacity
        ...
        {/* Impact Section */}
        <View className="p-4">
          <Text className="text-lg font-bold">Small Steps, Big Impact</Text>
          <TouchableOpacity
